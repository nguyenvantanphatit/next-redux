...
import { dragTask, removeTask, Status, reorderTask } from '@/lib/slices/tasksSlice'
...
export default function Task({
  ...
  const handleDrop = (e: React.DragEvent<HTMLDivElement>) => {
    ...
    if (data.id !== id && status === 'DONE') {
      dispatch(reorderTask({ draggedId: data.id, droppedId: id }))
    }
  }
  ...
  return (
    ...
    >
      ...
      <button className='cursor-pointer' onClick={() => dispatch(removeTask(id))}>
        <svg
